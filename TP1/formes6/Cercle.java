...
public class Cercle
{
    ...
    /**
     * Triple le diamètre du cercle.
     */
    public void tripleTaille2()
    {
        this.changeTaille(3*aDiametre);
    } // tripleTaille2()
     ...
     * @param pDistance nb de pixels dont il faut se deplacer vers la droite
     */
    public void depHorizontalG( final int pDistance )
    {
        this.efface();
        this.aXPosition= this.aXPosition - pDistance;
        this.dessine();
